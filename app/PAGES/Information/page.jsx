...
import { SectionDate } from '@/components/Components/Main/Sections/HomePage/SectionDate';
...
const Informations = () => {
  ...
  const [mainImage, setMainImage] = useState("/info/photo(1).svg");
  ...
  return (
    <div className='container mx-auto py-10'>
      ...
      <div className='pt-10 pb-10 flex items-center space-x-20'>
        <div className='flex space-x-5 w-[50%]'>
          ...
          <div className='flex flex-col justify-center items-center space-y-14 '>
            <Image
              src="/info/photo(2).svg"
              width={82}
              height={80}
              onClick={() => changeImage("/info/photo(2).svg")}
              className="cursor-pointer"
            />
            <Image
              src="/info/photo(3).svg"
              width={82}
              height={80}
              onClick={() => changeImage("/info/photo(3).svg")}
              className="cursor-pointer"
            />
            <Image
              src="/info/photo(4).svg"
              width={82}
              height={80}
              onClick={() => changeImage("/info/photo(4).svg")}
              className="cursor-pointer"
            />
            <Image
              src="/info/photo(5).svg"
              width={82}
              height={80}
              onClick={() => changeImage("/info/photo(5).svg")}
              className="cursor-pointer"
            />
          </div>
        </div>
      ...
      <div className='pt-10 space-y-5'>
        <h1 className='text-3xl text-[#23262F] font-semibold'>Vous pourrez aussi aimer</h1>
