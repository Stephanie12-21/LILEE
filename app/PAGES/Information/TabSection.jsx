  ...
  return (
    <Tabs defaultValue="description" className="w-full">
      ...
      <TabsContent value="description" >
        <Card className="border-none bg-[#fff1da]">
          <CardHeader>
          ...
          <CardContent className="space-y-7">
            <div className="space-y-1">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias recusandae ullam magnam. Laudantium necessitatibus cupiditate asperiores distinctio reprehenderit! Non excepturi accusantium deserunt sunt consequuntur recusandae! Adipisci eos voluptas blanditiis non culpa amet fuga similique ullam accusamus ipsa incidunt necessitatibus nobis, facere eum ratione maxime beatae fugit? Aliquam, est unde quis fugiat nemo suscipit praesentium eius ex cupiditate aspernatur, sapiente sit dignissimos. Distinctio praesentium id cumque, odit optio soluta. Magnam doloremque quibusdam vero odio sequi temporibus debitis veritatis suscipit, ad exercitationem? Fugiat quam perferendis magnam unde dolor. Quae veritatis corrupti reprehenderit, harum nostrum odio dicta consectetur fuga et, itaque ducimus nam.</p>
            </div>

            {/* aménagement */}
            <div className="space-y-3 pt-5">
              <h2 className="text-2xl font-semibold leading-none tracking-tight">Caractéristiques particulières</h2>
            ...
            {/* règlements */}
            <div className="space-y-3 pt-5">
              <h2 className="text-2xl font-semibold leading-none tracking-tight">Règlements à respecter</h2>
              <div className="container mx-auto pt-4 grid grid-cols-2 gap-6">
        ...
        <Card className="border-none bg-[#fff1da]">
          <CardHeader className="space-y-4">
            ...
            <CardDescription className="text-[#303236] text-[16px] ">
              Exprimez-vous, commentez et déposez un avis. Partagez vos expériences avec les autres.
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex flex-col items-start">
                <div className="flex justify-between pt-8">
                  <div className="flex space-x-5">
                    ...
                    <p className="text-[#182135] font-bold text-[18px] hover:underline hover:cursor-default">Nom d'utilisateur</p>
                    ...
                    <div className="flex space-x-5">
                      <p id="time" className="text-[#777E90] text-[14px]">Récent</p>
                    </div>
                  </div>
                  </div>
      ...
      <TabsContent value="localisation">
        <AspectRatio className="bg-slate-800 rounded-[24px] mt-5" width="300px" height="200px">
          <Image
